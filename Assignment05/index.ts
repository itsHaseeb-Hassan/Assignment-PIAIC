...
let evenOddNumber:number[]=[2,3,5,7,6,8,10,25,34,56,45];
...
function areaOfCircle(radius:number){
   let areaCircle:number=pi*radius*radius;
   return areaCircle;
...
let gradesNumber:number[]=[90,80,70,60,50,40,30];
...
function largestNumber(findNumber:number[]){
    let largest:number=findNumber[0];
