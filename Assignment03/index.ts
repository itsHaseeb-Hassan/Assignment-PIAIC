...
let temperatureCelsius:number=32;
let calculateTemperatureFahrenheit:number=32*(9/5)+32;
...
let givenValue:number=45;
let totalValue:number=60;
let percentage:number=(givenValue/totalValue)*100;
const cyanColor = "\x1b[36m"; 
const resetColor = "\x1b[33m"; 
...
if(priceOfProduct>=100){
    let calculateDiscountPrice:number=(10/100)*priceOfProduct;
    let totalPrice:number=priceOfProduct-calculateDiscountPrice;
    console.log("\x1b[36m%s\x1b[0m","Total Price After Discount",totalPrice,"\n");
}
else{
    let calculateDiscountPrice:number=(5/100)*priceOfProduct;
    let totalPrice:number=priceOfProduct-calculateDiscountPrice;
    console.log("\x1b[36m%s\x1b[0m","Total Price After Discount",totalPrice,"\n");
}
...
let tempratureInCelsius:number=20;
...
let numberOfDaysInyear:number=365;
...
let numberOfDaysInWeek:number=5;
...
let numberOfUnits:number=500;
let oneUnitPrice:number=28;
if(numberOfUnits<100){
    let withOutTaxBill:number=numberOfUnits*oneUnitPrice;
    console.log("\x1b[36m%s\x1b[0m","Total Bill Is",withOutTaxBill,'\n')
}
else if(numberOfUnits >=100 && numberOfUnits<200){
    let withOutTaxBill:number=numberOfUnits*oneUnitPrice;
     let addTax:number=(10/100)*withOutTaxBill;
     let totalBill:number=withOutTaxBill+addTax;
     console.log("\x1b[36m%s\x1b[0m","Total Bill Is",totalBill,'\n');
}
else if(numberOfUnits>=200 && numberOfUnits<500){
    let withOutTaxBill:number=numberOfUnits*oneUnitPrice;
    let addTax:number=(15/100)*withOutTaxBill;
    let totalBill:number=withOutTaxBill+addTax;
    console.log("\x1b[36m%s\x1b[0m","Total Bill Is",totalBill,'\n');
}
else{
    let withOutTaxBill:number=numberOfUnits*oneUnitPrice;
    let addTax:number=(25/100)*withOutTaxBill;
    let totalBill:number=withOutTaxBill+addTax;
    console.log("\x1b[36m%s\x1b[0m","Total Bill Is",totalBill,'\n');
}